        ...
        <div className="container mx-auto py-32 text-center xl:text-left flex items-center justify-center">
            ...
            className="flex-1 flex flex-col gap-6 w-full mx-auto items-center justify-center">
              ...
              className={`${
                errMessages
                  ? "border-red-600 focus-visible:border-red-600"
                  : "border-zinc-600 focus-visible:border-designColor"
              } flex items-center justify-center bg-[rgba(89,65,169,0.40)] text-sky-400 border-sky-400 rounded-full h-[70px] w-[200px] px-8 transition-all duration-300 overflow-hidden group animate-pulse`}>
          ...
          className="flex-1 flex flex-col mx-auto container gap-6 w-full justify-center items-center">
            ...
            <div className="flex-1 flex flex-row-reverse items-center justify-center group hover:text-accent cursor-pointer transition-all duration-300 mx-auto">
              <h3 className="flex flex-1 gap-2 group hover:text-accent cursor-pointer transition-all duration-300 mx-auto">Žikice Damnjanovića 15
